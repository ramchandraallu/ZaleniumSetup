...
//        await("Wait for the login link to displayed").atMost(20,TimeUnit.SECONDS)
//                .ignoreExceptions()
//                .until(lnkLogin::isDisplayed, is(true));

                await().atMost(20,TimeUnit.SECONDS)
                .ignoreExceptions()
                .untilAsserted(() -> Assert.assertEquals("Wait for the link to be displayed", lnkLogin.isDisplayed(), true));
